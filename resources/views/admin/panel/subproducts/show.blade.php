...
@section('content')
    <div class="page-header">
        <div class="container">
            <div class="row-fluid">
                <h1>Страница добавления продуктов к заказу № {{$publicOrderId}}</h1>
            </div>
        </div>
    </div>
    <div class="container" id="content_row" style="margin: 45px auto 45px auto;">
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                ...
                <form action="{{route('adminPanel.subproduct.add',['user' => $userId, 'order' => $orderId])}}" method="post">

                    {{ csrf_field() }}

                    <h4>Цвет:</h4>

                    <input name="product_id" class="hidden" id="productId"
                           value="{{$product_id}}">
                    ...
                    <div class="pull-right" style="margin-top: -15px;">
                        <button class="btn btn-primary">Добавить к заказу</button>
                    </div>
                </form>
