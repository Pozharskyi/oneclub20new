...
class CreateDevImportPartiesLogEditTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('dev_import_parties_log_edit', function(Blueprint $table){
            $table->increments('id');
    ...
    {
        Schema::table('dev_import_parties_log_edit', function(Blueprint $table){
